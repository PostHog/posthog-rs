...
- Read and follow [CONTRIBUTING.md](./CONTRIBUTING.md) before contributing to the SDK. It covers prerequisites, development commands, examples, and pull requests.
