...
if ! command -v python3 >/dev/null 2>&1; then
    echo "error: python3 is required to filter the public API snapshot." >&2
    exit 1
fi
...

{
    ...
    echo '# Generated builder setters for pub(crate) fields are omitted.'
    echo
...
python3 scripts/filter-public-api.py --repo-root "$repo_root" --package "$package" \
